...
# Sidebar filters
st.header(f":blue[Watchlist Pozos Vaca Muerta]")
...
st.header(f"📊 Producción de Pozos – {latest_date.strftime('%B %Y')}")

# Métricas destacadas – Producción de Gas
st.subheader("🔝 3 Pozos de Gas")
...
st.subheader("🔝 3 Pozos de Petróleo")
